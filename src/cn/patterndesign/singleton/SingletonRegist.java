 ...
 */
public class SingletonRegist {
	private static class SingletonHolder {
		private static final SingletonRegist instance = new SingletonRegist();
	}
	private SingletonRegist() {}
	public static final SingletonRegist getInstance() {
